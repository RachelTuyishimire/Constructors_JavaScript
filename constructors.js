...
class Car {
  ...
  const car1 = new Car("Hyndai", "Santa fe", 2020, true);
  console.log(car1)
...
// calculateRentalDuration that returns the rental duration in day
...
const car = new Car("Hyndai", "Santafe", 2020, true);
const rental = new RentalCar(car, "Christelle Uwase", "2023-05-01", "2023-05-05");
...
const question = new Question("When is christmas?", ["December25th", "June04th", "August24th", "July18th"]);
const userAnswer = "December25th";
...
const question1 = new Question("When is christmas?", ["December25th", "June04th", "August24th", "July18th"]);
const question2 = new Question("What is the largest lake in Rwanda?", ["Kivu", "Muhazi", "Burera", "Ruhondo"], "Rweru");
quiz1.addQuestion(question1);
quiz1.addQuestion(question2);

quiz1.submitAnswer("December25th");
quiz1.nextQuestion();
quiz1.submitAnswer("Kivu");
